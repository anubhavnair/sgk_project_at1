            ...
            <table class="table">
              ...
              <?php
                ...
                while ($row = $qry->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  <td><?=$row['general_date']?></td>
                  <td><?=$vehicle_name?></td>
                  <td><?=$row['noof_trips']?></td>
                  <td><?=$row['work_descp']?></td>
                  <td><?=$row['opening_meter']?></td>
                  <td><?=$row['opening_dip']?></td>
                  <td><?=$row['closing_meter']?></td>
                  <td><?=$row['closing_dip']?></td>
                  <td><?=$row['total_km']?></td>
                  <td><?=$row['general_desel']?></td>
                  <td><?=$row['general_average']?></td>
                  <td><?=$row['genral_remark']?></td>
    
                  <td>
                    <div class="d-flex justify-content-center align-items-center"><a href="general_data_entry_master_do.php?del_id=<?=$id?>"><svg
                        ...
                        </svg></a> &nbsp;&nbsp;<a href="general_data_entry_master.php?edit_id=<?=$id?>"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                          height="16" fill="blue" class="bi bi-pen-fill" viewBox="0 0 16 16">
                          <path
