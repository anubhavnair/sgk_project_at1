...
if (isset($_REQUEST["edit_id"])) {
        ...
        $qry = $db->query("UPDATE `tank_entry_master` SET `tank_entry_date`='$date',`area_id`='$select_area',`opening_meter`='$opening_meter ',`total_refil`='$total_refill',`closing_meter`='$closing_meter',`diesel_out`='$desel_out',`tankentry_description`=' $description',`tank_dip`='$dip',`tank_balance`='$balance',`updated_by`=' $created_by', `updated_on`=NOW() WHERE id= $edit_id ") or die("");
        ...
        $qry = $db->query("INSERT INTO `tank_entry_master`(`tank_entry_date`, `area_id`, `opening_meter`, `total_refil`, `closing_meter`, `diesel_out`, `tankentry_description`, `tank_dip`, `tank_balance`,`created_on`, `updated_by`) VALUES ('$date','$select_area','$opening_meter','$total_refill','$closing_meter','$desel_out','$description','$dip','$balance',NOW(),'$created_by')") or die("");
}
