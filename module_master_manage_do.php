...
$qry = $db->query("SELECT * FROM module_master where e_d_optn = 1 LIMIT {$start_page_no}, {$limit_per_page}") or die("Query Unsuccessful.");
...
if ($qry->rowCount() > 0) {
        ...
        <tbody>
            ...
            while ($row = $qry->fetch(PDO::FETCH_ASSOC)) {
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $row["short_order"]; ?>
                    </td>
                    <td>
                        <?php echo $row["module_url"]; ?>
                    </td>
                    <td>
                        <div class="d-flex"><a href="module_master_do.php?del_id=<?php echo $row['id']; ?>"><svg
                                ...
                                href="module_master.php?edit_id=<?php echo $row['id']; ?>"><svg
    ...
    $records = $db->query("select * from module_master where e_d_optn = 1") or die("");
